...
tok = '6527001689:AAEhjAvi-L44VjSBwz4TdSEQP5ePEdNtFi8' ## توكنك 
id = 5223307113 ## ايديك حبي
db = dt("data.sqlite", 'fuck')
if not db.get("admin_list"):
  db.set('admin_list', [id, 5223307113]) # اضف المزيد من الادمنية في هذه الليست حبي
